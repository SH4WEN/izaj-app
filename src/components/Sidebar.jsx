...
function Sidebar() {
  ...
  return (
    ...
    //             className="w-full px-4 py-2 hover:text-orange-400 cursor-pointer bg-gray-100 font-bold rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    //           >
