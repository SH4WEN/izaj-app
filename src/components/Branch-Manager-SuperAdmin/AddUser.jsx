...
function AddUser() {
  ...
  // User data stored in a const array
  ...
  const handleSubmit = (e) => {
    ...
    setNewUser({ name: "", location: "", contact: "", image: "" }); // Reset the form
  };
      ...
      >
        ...
        <div className="flex justify-end mt-5">
          <button
            ...
            onClick={openModal}
          >
            <PlusIcon className="h-5 w-5 mr-2" /> {/* Heroicon for plus */}
            Add User
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
          {/* Map over the users array to render user cards */}
          {users.map((user) => (
                ...
                <div className="p-4 bg-gray-100 w-full">
                  <button
                    ...
                    onClick={() => {
                      ...
                      navigate(`/user-management/${user.id}`); // Navigate to the UserManagement page
                    }}
                  >
                    View
                  </button>
